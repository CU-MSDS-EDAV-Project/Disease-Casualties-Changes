...
Data Source 3: <a href="https://data.cdc.gov/Vaccinations/Weekly-Cumulative-Influenza-Vaccination-Coverage-C/eudc-n39h">Weekly Cumulative Influenza Vaccination Coverage-Youth</a>;<a href="https://data.cdc.gov/Flu-Vaccinations/Weekly-Cumulative-Influenza-Vaccination-Coverage-A/2v3t-r3np">Weekly Cumulative Influenza Vaccination Coverage-Adult</a>  
...
# Change column name to its corresponding index
...
ggplot(missing_data_df1, aes(x = Variable, y = MissingValues)) +
  ...
  labs(x = "Variable Index", y = "Number of Missing Values", title = "Missing Data by Columns for Data2 File")
```
