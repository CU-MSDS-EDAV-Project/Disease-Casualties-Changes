...
missing_data_df <- data.frame(
  Variable = names(missing_values_counts),
  MissingValues = missing_values_counts
)
# Plotting the bar chart
ggplot(missing_data_df, aes(x = Variable, y = MissingValues)) +
  geom_bar(stat = "identity") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(x = "Variables", y = "Number of Missing Values", title = "Missing Data by Variable For Data1 File")
...
# Creating a data frame for ggplot
variable_indices <- 1:length(missing_counts)
missing_data_df1 <- data.frame(
  Variable = variable_indices,
  MissingValues = missing_counts
)

# Plotting the bar chart
ggplot(missing_data_df1, aes(x = Variable, y = MissingValues)) +
  geom_bar(stat = "identity") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(x = "Variable Index", y = "Number of Missing Values", title = "Missing Data by Variable For Data2 File")
ggsave('data2missing.png')
```
...
ggplot(missing_data_df3a, aes(x = Variable, y = MissingValues)) +
  geom_bar(stat = "identity") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(x = "Variables", y = "Number of Missing Values", title = "Missing Data by Variable For Data3_Adult File")
# Creating a data frame for ggplot
...
ggplot(missing_data_df3y, aes(x = Variable, y = MissingValues)) +
  geom_bar(stat = "identity") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(x = "Variables", y = "Number of Missing Values", title = "Missing Data by Variable For Data3_Youth File")
```
